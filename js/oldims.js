...
$(document).ready(function (){
	...
	hd = '<div class="logo">'
	//hd += '<a href="/project-3/ims.html"> <img src="/test/churchlogo.png" </a>'
	hd += '</div>'
	$('#header').html(hd);
            ...
            var resJson = JSON.parse(reqObj.responseText);
                ...
                if (inJson["pageid"] == "home"){
                    if (inJson["action"] == "getfirstpage"){
                        ...
                        var cn = renderFourthPage(resJson,timeStamp,dic)
                        $("#main").html(cn);
                    }
...
////////////////////////////////////////////
function renderFourthPage(resJson,timeStamp,dic){
